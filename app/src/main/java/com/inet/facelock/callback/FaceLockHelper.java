...
public class FaceLockHelper {
	 ...
	 * @param fmin
	 *            minimum distance between 2 eyes.
	 * @param fmax
	 *            maximum distance between 2 eyes.
	 * @param resizeRatio
	 *            scale factor to detect faces.
	 *            default value is 1.18.
	 *            the smaller, the slower
	 * @param modelpath
	 *            deep CNN model file's path.
	 * @param weightpath
	 *            deep CNN weight file's path.
	 * @return
	 * 		result
	 */
	 ...
	 *            its format is RGBA or YUV420
	 * @param pfaceRect   
	 * 				int array of 4 points' coordinates of face region.
	 * @param plandmarks
	 * 				float array of face landmarks' coordinates
