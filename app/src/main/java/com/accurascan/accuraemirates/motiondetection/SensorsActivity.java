package com.accurascan.accuraemirates.motiondetection;
...
public class SensorsActivity extends AppCompatActivity implements SensorEventListener {
    ...
    public void onSensorChanged(SensorEvent evt) {
        ...
        if ((Float.compare(prevGrav, 0.0f) != 0 && (sensorMag == null || Float.compare(prevMag, 0.0f) != 0)) && (gravDiff > gravThreshold || magDiff > magThreshold)) {
